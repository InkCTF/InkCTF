...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    condition: (stats) => stats.completedLevels.length >= 6
  },
  {
    ...
    condition: (stats) => stats.completedLevels.includes(3)
  },
  {
    ...
    icon: <Award className="h-5 w-5 text-[#e86bdf]" />,
    condition: (stats) => stats.completedLevels.includes(4) 
  },
  {
    ...
    condition: (stats) => stats.completedLevels.includes(5) 
  },
  {
    ...
    condition: (stats) => stats.completedLevels.includes(6)
  }
];
